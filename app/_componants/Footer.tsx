...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
    <div className="ttte text-center  p-[60px]">
      ...
      <a
        href="#"
        className="mt-8 inline-block duration-500 rounded-full border border-[#31511E] px-12 py-3 text-sm font-medium text-white hover:bg-[#31511E] hover:text-white focus:ring-3 focus:outline-hidden"
      >
        Get Started
      </a>
    </div>
    ...
    <div
      className="tte mt-16 border-t border-[#ccc] pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"
    >
